...
const controlClass = 'field-input h-11 pl-9';
    ...
    <div className="rounded-[var(--radius-card)] border border-card-border bg-card p-5 shadow-card">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-[repeat(4,minmax(0,1fr))_auto] lg:items-end">
        ...
        <label className="block">
          <span className="field-label mb-1.5">{t('audit.filter.dateRange')}</span>
        ...
        {/* Loại thao tác */}
        <label className="block">
          <span className="field-label mb-1.5">{t('audit.filter.eventType')}</span>
          <div className="relative">
            <LeadingIcon>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
        ...
        <label className="block">
          <span className="field-label mb-1.5">{t('audit.filter.user')}</span>
          <div className="relative">
            <LeadingIcon>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
        ...
        <label className="block">
          <span className="field-label mb-1.5">{t('audit.filter.userScope')}</span>
          <div className="relative">
            <LeadingIcon>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
        ...
        <button
          type="button"
          onClick={apply}
          className="flex h-11 items-center justify-center gap-2 rounded-[var(--radius-button)] border border-primary/20 bg-primary-ghost px-5 text-sm font-semibold text-primary transition-colors hover:bg-primary/10"
        >
