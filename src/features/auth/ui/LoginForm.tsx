...
const INPUT_BASE =
  'h-12 w-full rounded-xl border border-[#C3C9B9] bg-white font-jakarta text-sm text-[#1B1C17] placeholder:text-[#6B7280] transition-colors focus:border-[#406623] focus:outline-none focus:ring-1 focus:ring-[#406623]';
const LABEL_CLASS =
...
export function LoginForm() {
  ...
  return (
    <div className="flex w-full max-w-[448px] flex-col gap-5">
      ...
      <div className="flex flex-col gap-6 rounded-3xl border border-[#C3C9B9]/30 bg-white p-6 shadow-[0_4px_20px_rgba(0,0,0,0.05)]">
        ...
        <div className="border-t border-[#C3C9B9]/30 pt-6">
          <button
            id="login-sso-btn"
            type="button"
