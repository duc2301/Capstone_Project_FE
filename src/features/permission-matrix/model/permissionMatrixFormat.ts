...
/* Các tuỳ chọn của dropdown theo khu vực (ma trận chỉ còn hàng folder).
 * N/R mọi vùng, thêm W chỉ ở WIP. */
export const levelOptionsFor = (area: MatrixArea): PermissionLevel[] =>
  areaAllowsWrite(area)
